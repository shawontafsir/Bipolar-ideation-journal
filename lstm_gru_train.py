...
def train_with_cross_validation(_tokenizer, _model_class, _model_params, _config, features, labels, _k_folds):
...
def train(_model, _config, _train_loader, _validation_loader, _y_validation_tensor, fold=None):
    ...
    for epoch in range(epochs):
        ...
        for batch in tqdm_train_loader:
            ...
            # For Bert embeddings
            input_ids, labels = batch[0].to(device), batch[2].to(device)
...
def evaluate(_model, _test_loader, _y_test_tensor, fold=None):
    # Check if GPU is available
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    _model = _model.to(device)
...
def evaluate_with_cross_validation(_tokenizer, _model_class, _model_params, _x_test, _y_test, _k_folds):
...
if __name__ == "__main__":
    ...
    #     tokenizer, LSTM, model_params, config, pd.concat([X_train, X_valid]), pd.concat([y_train, y_valid]), _k_folds=k_folds
    # )
    # evaluate_with_cross_validation(tokenizer, LSTM, model_params, X_test, y_test, k_folds)
    ...
    # # test_loader, y_test_tensor = create_test_loader(tokenizer, X_test, y_test)
    #
    # print("BiGRU with Attention:")
    # tic = time.perf_counter()
    # model_params.update(dict(is_bidirectional=True, has_attention=True))
    # train_with_cross_validation(
    #     tokenizer, GRU, model_params, config, pd.concat([X_train, X_valid]),
    #     pd.concat([y_train, y_valid]), _k_folds=k_folds
    # )
    # evaluate_with_cross_validation(tokenizer, GRU, model_params, X_test, y_test, k_folds)
    # # model = LSTM(**model_params)
    # # train(model, config, train_loader, validation_loader, y_validation_tensor)
    # # print(evaluate(model, test_loader, y_test_tensor))
    # toc = time.perf_counter()
    # print(f"Trained BiGRU with Attention model in {toc - tic:0.4f} seconds")
    #
    # print("BiGRU:")
    # tic = time.perf_counter()
    # model_params.update(dict(is_bidirectional=True, has_attention=False))
    ...
    # # print(evaluate(model, test_loader, y_test_tensor))
    # toc = time.perf_counter()
    # print(f"Trained BiGRU model in {toc - tic:0.4f} seconds")
    #
    ...
    # # print(evaluate(model, test_loader, y_test_tensor))
    # toc = time.perf_counter()
    # print(f"Trained GRU with Attention model in {toc - tic:0.4f} seconds")
    #
    # print("GRU:")
    # tic = time.perf_counter()
    # model_params.update(dict(is_bidirectional=False, has_attention=False))
    ...
    # # print(evaluate(model, test_loader, y_test_tensor))
    # toc = time.perf_counter()
    # print(f"Trained GRU model in {toc - tic:0.4f} seconds")
    ...
    # # ------------------- Train GRU with Glove Embedding ---------------------------------
    # glove_path = "./embeddings/glove.6B.300d.txt"
    #
    # print("BiGRUWithAttentionWithGlove:")
    # model_params.update(
    #     dict(
    #         embedding_type='glove', pretrained_embedding_path=glove_path, vocab=vocab, embedding_dim=300,
    #         is_bidirectional=True, has_attention=True
    ...
    # evaluate(model, test_loader, y_test_tensor)
    #
    # print("GRUWithAttentionWithGlove:")
    # model_params.update(
    #     dict(
    #         embedding_type='glove', pretrained_embedding_path=glove_path, vocab=vocab, embedding_dim=300,
    #         is_bidirectional=False, has_attention=True
    ...
    # word2vec_path = "./embeddings/GoogleNews-vectors-negative300.bin"
    #
    # print("BiGRUWithAttentionWithWord2Vec:")
    # model_params.update(
    #     dict(
    #         embedding_type='word2vec', pretrained_embedding_path=word2vec_path, vocab=vocab, embedding_dim=300,
    #         is_bidirectional=True, has_attention=True
    ...
    # evaluate(model, test_loader, y_test_tensor)
    #
    # print("GRUWithAttentionWithWord2Vec:")
    # model_params.update(
    #     dict(
    #         embedding_type='word2vec', pretrained_embedding_path=word2vec_path, vocab=vocab, embedding_dim=300,
    #         is_bidirectional=False, has_attention=True
