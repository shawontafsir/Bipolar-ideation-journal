...
# print("Sentence-BERT:")
# tic = time.perf_counter()
# model_sbert = ModelTrain(
#     'sentence-transformers/all-mpnet-base-v2',
#     label_encoder, X_train, X_test, X_valid, y_train, y_test, y_valid, k_folds=k_folds
# )
# toc = time.perf_counter()
# print(f"Trained Sentence-BERT model in {toc - tic:0.4f} seconds")
